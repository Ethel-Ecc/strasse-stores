# This is the application factory for strasse-store-blog

import os
from flask import Flask
from . import database_store_blog
...
def make_app(store_blog_configuration_test=None):
    ...
    app.config.from_mapping(SECRET_KEY=str(os.urandom(16)),
                            DATABASE=os.path.join(app.instance_path, 'strasse-store-blog.sqlite3'))
